...
hotel_demand <- hotel_demand %>%
  ...
  select(
    ...
    -previous_bookings_not_canceled, -market_segment, -agent, -company, -country, -meal,
    -assigned_room_type, -reserved_room_type, -customer_type, -days_in_waiting_list, -deposit_type,
    -booking_changes, -reservation_status_date, -reservation_status, -customer_type,
    -required_car_parking_spaces, -babies, -children
  ) %>%
...
hotel_train %>% 
  ggplot(aes(x = is_canceled, fill = reserved_room_type)) +
  geom_bar(position = "fill") +
...
hotel_logistic <- train(
    ...
    metric = "Accuracy",
    na.action = na.omit
) # take out variable with few observations of one level
