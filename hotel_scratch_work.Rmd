...
hotel_demand <- hotel_demand %>%
  ...
  select(
    ...
    -previous_bookings_not_canceled, -market_segment, -agent, -company, -reservation_status_date,
    -country, -assigned_room_type, -reserved_room_type, -previous_cancellations, -required_car_parking_spaces,
